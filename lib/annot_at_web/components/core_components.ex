defmodule AnnotAtWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnnotAtWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnnotAtWeb.Gettext, "errors", msg, opts)
    end
  end
